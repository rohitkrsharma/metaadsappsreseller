...
const WalletHistory = ({ breadcrumbs, onAdd, onToggleView, view }) => {
  const data = [
    ...
    { id: 2, InvoiceNo: 'UC20240530-0002', Charge: '230', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 3, InvoiceNo: 'UC20240530-0003', Charge: '432', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 4, InvoiceNo: 'UC20240530-0004', Charge: '564', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 5, InvoiceNo: 'UC20240530-0005', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 6, InvoiceNo: 'UC20240530-0006', Charge: '765', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 7, InvoiceNo: 'UC20240530-0007', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 8, InvoiceNo: 'UC20240530-0008', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 9, InvoiceNo: 'UC20240530-0009', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 10, InvoiceNo: 'UC20240530-00010', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 11, InvoiceNo: 'UC20240530-00011', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 12, InvoiceNo: 'UC20240530-00012', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
    { id: 13, InvoiceNo: 'UC20240530-00013', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Done', },
    { id: 14, InvoiceNo: 'UC20240530-00014', Charge: '234', Date: '22-05-2024 10:01:30', Token: 'TRON(TRC20)', status: 'Pending', },
  ];
  ...
  return (
    <>
      <div className='flex justify-between mb-4'>
        ...
        <div>
          <SearchBar onAdd={onAdd} showAddAndView={false} view={view} onToggleView={onToggleView} />
        </div>
      </div>
